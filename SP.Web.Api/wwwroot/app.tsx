...
import { AddStudentView } from "./views/addStudent";
...
import { MountCourseView } from "./views/mountCourse";
...
import { MountedCoursesView } from "./views/mountedCoursesView";
...
export class App {
  ...
  static routes = {
    ...
    "/app/#mountCourse": () => new MountCourseView(App.mountCourseViewModel),
    ...
    "/app/#school": () => new SchoolView(new SchoolVm()),
    ...
    "/app/#mountedCourses": () => new MountedCoursesView(new MountedCourseVm()),
  };
